...
const apiChatForm = axios.create({
...
apiChatForm.interceptors.request.use(
  async (request) => {
    ...
    //console.log("############################################");
    //console.log("### [apiChatFormUtil] request=", request);
    //console.log("### [apiChatFormUtil] token=", token);
    //console.log("### [apiChatFormUtil] privateKey=", privateKey);
    //console.log("### [apiChatFormUtil] params=", params);
    //console.log("### [apiChatFormUtil] signature=", signature);

    // form.append("HEADER[Authorization]", "bearer " + token);
    // form.append("HEADER[x-teletalk-signature]", signature);
    // form.append("HEADER[Content-Type]", "application/json");
    // form.append("HEADER[Accept]", "application/json");
...
apiChatForm.interceptors.response.use(
  async (response) => {
    ...
    async (error) => {
      console.log( "apiChatFormUtil.js/axios.interceptors.response.use :: error :: {}" ,error );
      store.dispatch("commonStore/AC_COMMON_PROGRESS_BAR", false);
