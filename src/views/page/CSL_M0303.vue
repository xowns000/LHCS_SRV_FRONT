...
<!--                </div>-->
            ...
            <div class="pl-form-inline">
              ...
              <div class="pl-desc">
                <v-select class="pl-form" :items="dropItems" placeholder="선택하세요"></v-select>
              </div>
            </div>
            <div class="pl-form-inline">
              <span class="pl-label">
              ...
              <div class="pl-desc">
                <v-select class="pl-form" :items="dropItems2" placeholder="선택하세요"></v-select>
              </div>
            </div>
            <div class="pl-form-inline">
            ...
            <div class="pl-form-inline">
              <span class="pl-label">
                <v-select class="pl-form" :items="dropItems3" placeholder="선택하세요"></v-select>
              </span>
              <div class="pl-desc">
                <v-text-field class="pl-form " placeholder="검색어 입력" />
...
<script>
export default {
    name:"MENU_CSL_M0303", //name은 'MENU_' + 파일명 조합
 ...
 data() {
    return {
      ...
      dropItems: ['전체', '수신', '발신'],
      dropItems2: ['전체', '상담', '포기', '콜백'],
      dropItems3: ['사용자 ID', '고객 전화번호', '내선번호', '상담직원명', ],
